...
class ImageTextDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
                 ...
                 imagefile_template: str='img_{:12d}.jpg',
                 transform = None,
                 random_shift: bool = True,
                 test_mode: bool = False):
        super(ImageTextDataset, self).__init__()

        #annotationfile structure: file_name_captions
    ...
    def _load_image(self, directory):
        return Image.open(os.path.join(directory)).convert('RGB')
    ...
    def __getitem__(self, index):
        ...
        image_text_pair = {}
        image_text_pair["image"] = self._get(record)
        image_text_pair["text"] = record.text
